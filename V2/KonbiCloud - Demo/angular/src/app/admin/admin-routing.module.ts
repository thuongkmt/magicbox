        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    //migrate from old cloud
                    { path: 'machinestatuses', component: MachineStatusesComponent, data: { permission: 'Pages.Administration' } },
                    { path: 'machinesconfig', component: MachinesComponent, data: { permission: 'Pages.Administration' } },

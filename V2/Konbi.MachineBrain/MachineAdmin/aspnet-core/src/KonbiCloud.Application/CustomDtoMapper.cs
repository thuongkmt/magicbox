...
using Topup = KonbiCloud.Inventories.Topup;
...
namespace KonbiCloud
{
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
           ...
           configuration.CreateMap<CreateOrEditCreditHistoryDto, CreditHistory>();
           configuration.CreateMap<CreditHistory, CreditHistoryDto>();
           configuration.CreateMap<CreateOrEditUserCreditDto, UserCredit>();
           configuration.CreateMap<UserCredit, UserCreditDto>();
           ...
           configuration.CreateMap<PlateCategory, PlateCategoryDto>();
            ...
            configuration.CreateMap<Topup, KonbiCloud.Inventories.Dtos.TopupDto>();
        }
    }
}
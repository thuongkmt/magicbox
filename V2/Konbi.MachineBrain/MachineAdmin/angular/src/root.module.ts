        ...
        return new Promise<boolean>((resolve, reject) => {
            ...
            AppPreBootstrap.run(appBaseUrl, () => {
                ...
                localForage.config({
                    ...
                    name: 'Konbini Magicbox Backend',
                    version: 1.0,
                    storeName: 'abpzerotemplate_local_storage',
                    description: 'Cached data for KonbiCloud'
                });
                    ...
                    (result) => {
                        ...
                        if (metaImage) {
                            ...
                            if (!appSessionService.tenant || !appSessionService.tenant.logoId) {
                                metaImage.setAttribute('content', window.location.origin + '/assets/common/images/app-logo-on-' + ui.getAsideSkin() + '.svg');
                            } else {

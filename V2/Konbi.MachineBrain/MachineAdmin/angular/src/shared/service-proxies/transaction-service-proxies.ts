...
export class TransactionDto {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.inventoriesQuantity = data["inventoriesQuantity"];
            ...
            this.otherInfo1 = data["otherInfo1"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["inventoriesQuantity"] = this.inventoriesQuantity;
        ...
        data["otherInfo1"] = this.otherInfo1;

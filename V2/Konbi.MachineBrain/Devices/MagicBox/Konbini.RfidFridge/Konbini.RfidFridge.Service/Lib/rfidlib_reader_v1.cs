...
namespace RFIDLIB
{
    ...
    class rfidlib_reader_v1
    {

#if UNICODE
        /**********************************************Use Unicode Character Set********************************************/
        [DllImport("rfidlib_reader_v1.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
      ...
      public static extern int RDR_BuffMode_StopReportCollection(UIntPtr hr)  ;
        ...
        [DllImport("rfidlib_reader_v1.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32 RDR_GetLibVersion(StringBuilder buf, UInt32 nSize);
        [DllImport("rfidlib_reader_v1.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_LoadReaderDrivers(string drvpath);
        [DllImport("rfidlib_reader_v1.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]

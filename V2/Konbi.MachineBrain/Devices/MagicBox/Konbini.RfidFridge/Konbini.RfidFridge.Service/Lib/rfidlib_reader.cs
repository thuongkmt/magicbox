...
namespace RFIDLIB
{
    ...
    class rfidlib_reader
    {
        ...
        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_FridgeInventory(UIntPtr hr, Byte mode, Byte mask);

        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_FridgeParseTagDataReport(UIntPtr hTagReport, ref Byte tag_sta, ref Byte ant_id, Byte[] tag_data, ref Byte nSize);

        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern UIntPtr RDR_CreateDownloadTagsOperations();

        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_AddOneDownloadTagOperation(UIntPtr hOperas, Byte[] uid, Byte uidlen, Byte ant);

        [DllImport("rfidlib_reader.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int RDR_FridgeDownloadTag(UIntPtr hr, UIntPtr hOperas, Byte mode);
#else

...
namespace KonbiCloud.Web.Startup
{
    ...
    public class KonbiCloudWebHostModule : AbpModule
    {
        ...
        public override void PostInitialize()
        {
            ...
            workManager.Add(IocManager.Resolve<RefreshCacheJob>());
            workManager.Add(IocManager.Resolve<SendEmailJob>());
            workManager.Add(IocManager.Resolve<UpdateMachineInventoryToDbJob>());

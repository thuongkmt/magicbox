...
namespace KonbiCloud.Migrations
{
    ...
    partial class KonbiCloudDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KonbiCloud.Inventories.CurrentInventory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("CurrentInventory");
                });

            modelBuilder.Entity("KonbiCloud.Inventories.InventoryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<long?>("DetailTransactionId");
                    ...
                    b.Property<int?>("TrayLevel");

                    b.HasKey("Id");

                    b.HasIndex("DetailTransactionId");
            ...
            modelBuilder.Entity("KonbiCloud.Inventories.Topup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid?>("PreviousTopupId");

                    b.Property<int?>("RestockSessionId");

                    b.Property<string>("RestockerName");
                    ...
                    b.HasIndex("PreviousTopupId");

                    b.HasIndex("RestockSessionId");

                    b.ToTable("Topups");
                });

            modelBuilder.Entity("KonbiCloud.Inventories.TopupHistory", b =>
                {
                    b.Property<Guid>("TopupId");
                    ...
                    b.HasKey("TopupId", "InventoryId");

                    b.HasIndex("InventoryId");

                    b.ToTable("TopupInventory");
                });

            modelBuilder.Entity("KonbiCloud.Machines.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("CustonInfoesJson");
            ...
            modelBuilder.Entity("KonbiCloud.Machines.UserMachine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("KonbiCloud.Products.ProductCategoryRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("KonbiCloud.Products.ProductMachinePrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ProductMachinePrice");
                });

            modelBuilder.Entity("KonbiCloud.Products.ProductTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("KonbiCloud.Resources.Resource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("KonbiCloud.Restock.RestockSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("KonbiCloud.Restock.RestockSessionHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("CapacityChange");
                    ...
                    b.Property<Guid>("LoadoutItemId");

                    b.Property<Guid?>("NewProduct");

                    b.Property<Guid?>("OldProduct");

                    b.Property<string>("PriceChange");

                    b.Property<string>("QuantityChange");

                    b.Property<Guid>("RestockSessionId");

                    b.HasKey("Id");

                    b.HasIndex("LoadoutItemId");

                    b.HasIndex("RestockSessionId");

                    b.ToTable("RestockSessionHistory");
                });
            ...
            modelBuilder.Entity("KonbiCloud.Settings.AlertConfiguration", b =>
                {
                    ...
                    b.Property<int?>("WhenFrozenMachineTemperatureAbove");
            ...
            modelBuilder.Entity("KonbiCloud.TemperatureLogs.TemperatureLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("KonbiCloud.Transactions.TransactionDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("LocalInventoryId");
            ...
            modelBuilder.Entity("KonbiCloud.Inventories.InventoryItem", b =>
                {
                    b.HasOne("KonbiCloud.Transactions.DetailTransaction", "Transaction")
                        ...
                        .HasForeignKey("DetailTransactionId");
                    ...
                    b.HasOne("KonbiCloud.Inventories.Topup", "Topup")
                        .WithMany("Inventory")
            ...
            modelBuilder.Entity("KonbiCloud.Inventories.Topup", b =>
                {
                    ...
                    b.HasOne("KonbiCloud.Inventories.Topup", "PreviousTopup")
                        .WithMany()
                        .HasForeignKey("PreviousTopupId");

                    b.HasOne("KonbiCloud.Restock.RestockSession", "RestockSession")
                        .WithMany()
                        .HasForeignKey("RestockSessionId");
                });

            modelBuilder.Entity("KonbiCloud.Inventories.TopupHistory", b =>
                {
                    b.HasOne("KonbiCloud.Inventories.InventoryItem", "InventoryItem")
                        .WithMany()
            ...
            modelBuilder.Entity("KonbiCloud.Machines.UserMachine", b =>
                {
                    ...
                    b.HasOne("KonbiCloud.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("KonbiCloud.Products.ProductCategoryRelation", b =>
                {
                    b.HasOne("KonbiCloud.Products.ProductCategory", "ProductCategory")
            ...
            modelBuilder.Entity("KonbiCloud.Restock.RestockSessionHistory", b =>
                {
                    b.HasOne("KonbiCloud.Machines.LoadoutItem", "LoadoutItem")
                        .WithMany()
                        .HasForeignKey("LoadoutItemId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("KonbiCloud.Inventories.Topup", "RestockSession")
                        .WithMany()
                        .HasForeignKey("RestockSessionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("KonbiCloud.Transactions.TransactionDetail", b =>
                {
                    ...
                    b.HasOne("KonbiCloud.Transactions.DetailTransaction", "DetailTransaction")
                        .WithMany()
                        .HasForeignKey("TransactionId");
                });

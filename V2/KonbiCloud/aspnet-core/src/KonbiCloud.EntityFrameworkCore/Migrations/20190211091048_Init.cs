        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationTime = table.Column<DateTime>(nullable: false),
                    CreatorUserId = table.Column<long>(nullable: true),
                    ChangeIssued = table.Column<decimal>(nullable: false),
                    Amount = table.Column<decimal>(nullable: false),
                    CashInfo = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashDetail", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApproveCode = table.Column<string>(nullable: true),
                    EntryMode = table.Column<string>(nullable: true),
                    AppLabel = table.Column<string>(nullable: true),
                    Aid = table.Column<string>(nullable: true),
                    Tc = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashlessDetail", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "HardwareDiagnosticDetails",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ...
                    HardwareDiagnosticId = table.Column<long>(nullable: false),
                    OriginId = table.Column<long>(nullable: false),
                    Level = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HardwareDiagnosticDetails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginCreatedDate = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MachineErrorSolutions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(nullable: true),
                    Name = table.Column<string>(nullable: false),
                    FromHrs = table.Column<string>(nullable: true),
                    ToHrs = table.Column<string>(nullable: true),
                    IsSynced = table.Column<bool>(nullable: false),
                    SyncDate = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatorUserId = table.Column<long>(nullable: true),
                    MachineID = table.Column<string>(nullable: true),
                    VmcLevel = table.Column<string>(nullable: true),
                    VmcOk = table.Column<bool>(nullable: false),
                    IucOk = table.Column<bool>(nullable: false),
                    CykloneOk = table.Column<bool>(nullable: false),
                    MdbOk = table.Column<bool>(nullable: false),
                    IsSynced = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendingStatues", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MachineErrorCode = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MachineErrors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MachineErrors_Machines_MachineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendingHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VendingHistories_Machines_MachineId",
                        column: x => x.MachineId,
                        principalTable: "Machines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(nullable: false),
                    Desc = table.Column<string>(nullable: true),
                    ShortDesc1 = table.Column<string>(nullable: true),
                    ShortDesc2 = table.Column<string>(nullable: true),
                    ShortDesc3 = table.Column<string>(nullable: true),
                    ImageUrl = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    TranCode = table.Column<Guid>(nullable: false),
                    TenantId = table.Column<int>(nullable: true),
                    ...
                    Status = table.Column<int>(nullable: false),
                    Amount = table.Column<decimal>(nullable: false),
                    CashlessDetailId = table.Column<int>(nullable: true),
                    CashDetailId = table.Column<int>(nullable: true),
                    TransactionId = table.Column<string>(nullable: true),
                    MachineId = table.Column<Guid>(nullable: true),
                    MachineName = table.Column<string>(nullable: true),
                    SessionId = table.Column<Guid>(nullable: true),
                    TopupId = table.Column<Guid>(nullable: true),
                    Buyer = table.Column<string>(nullable: true),
                    BeginTranImage = table.Column<string>(nullable: true),
                    EndTranImage = table.Column<string>(nullable: true),
                    TranVideo = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Transactions_CashDetail_CashDetailId",
                        column: x => x.CashDetailId,
                        principalTable: "CashDetail",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_CashlessDetail_CashlessDetailId",
                        column: x => x.CashlessDetailId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MachineErrors_MachineId",
                table: "MachineErrors",
                column: "MachineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CashDetailId",
                table: "Transactions",
                column: "CashDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CashlessDetailId",
                table: "Transactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendingHistories_MachineId",
                table: "VendingHistories",
                column: "MachineId");
        }

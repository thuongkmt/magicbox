namespace KonbiCloud.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        {
            public const string ChannelName = "Slack.ChannelName";
            public const string HookUrl = "Slack.HookUrl";
            public const string UserName = "Slack.UserName";
            public const string ServerName = "Slack.ServerName";
        }
    }
}
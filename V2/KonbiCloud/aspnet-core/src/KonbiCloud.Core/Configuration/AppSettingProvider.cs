    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[] {
                ...
                new SettingDefinition(AppSettingNames.WooUrl, "", scopes: SettingScopes.All, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.WooConsumerKey, "", scopes: SettingScopes.All, isVisibleToClients: true),
                new SettingDefinition(AppSettingNames.WooConsumerSecret, "", scopes: SettingScopes.All, isVisibleToClients: true),
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                //Slack for tenant
                new SettingDefinition(AppSettings.Slack.ChannelName, GetFromSettings(AppSettings.Slack.ChannelName, ""), scopes: SettingScopes.Tenant, isVisibleToClients: true),
                new SettingDefinition(AppSettings.Slack.HookUrl, GetFromSettings(AppSettings.Slack.HookUrl, ""), scopes: SettingScopes.Tenant, isVisibleToClients: true),
                new SettingDefinition(AppSettings.Slack.UserName, GetFromSettings(AppSettings.Slack.UserName, ""), scopes: SettingScopes.Tenant, isVisibleToClients: true),
                new SettingDefinition(AppSettings.Slack.ServerName, GetFromSettings(AppSettings.Slack.ServerName, ""), scopes: SettingScopes.Tenant, isVisibleToClients: true),
            };
        }

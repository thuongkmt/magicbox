...
namespace KonbiCloud.Features
{
    public class AppFeatureProvider : FeatureProvider
    {
        public override void SetFeatures(IFeatureDefinitionContext context)
        {
            ...
            context.Create(AppFeatures.RFIDTableFeature,
                defaultValue: "false",
                displayName: L("RFIDTableFeature"),
                inputType: new CheckboxInputType());

            context.Create(AppFeatures.CustomerKonbiWalletFeature,
                defaultValue: "true",
                displayName: L("CustomerKonbiWalletFeature"),
                inputType: new CheckboxInputType());
        }

namespace KonbiCloud.Features
{
    public static class AppFeatures
    {
        ...
        public const string RFIDTableFeature = "App.RFIDTableFeature";
        public const string CustomerKonbiWalletFeature = "App.CustomerKonbiWalletFeature";
    }
}
...
import { CreateOrEditRestockSessionModalComponent } from './create-or-edit-restockSession-modal.component';

import { ViewRestockSessionModalComponent } from './view-restockSession-modal.component';
...
export class RestockSessionsComponent extends AppComponentBase {
    ...
    @ViewChild('createOrEditRestockSessionModal') createOrEditRestockSessionModal: CreateOrEditRestockSessionModalComponent;
    @ViewChild('viewRestockSessionModalComponent') viewRestockSessionModal: ViewRestockSessionModalComponent;   
    ...
    restockerNameFilter = '';
    maxRestockedFilter : number;
		maxRestockedFilterEmpty : number;
		minRestockedFilter : number;
		minRestockedFilterEmpty : number;
    maxUnloadedFilter : number;
		maxUnloadedFilterEmpty : number;
		minUnloadedFilter : number;
		minUnloadedFilterEmpty : number;
    ...
    getRestockSessions(event?: LazyLoadEvent) {
        ...
        this._restockSessionsServiceProxy.getAll(
            ...
            this.maxRestockedFilter == null ? this.maxRestockedFilterEmpty: this.maxRestockedFilter,
            this.minRestockedFilter == null ? this.minRestockedFilterEmpty: this.minRestockedFilter,
            this.maxUnloadedFilter == null ? this.maxUnloadedFilterEmpty: this.maxUnloadedFilter,
            this.minUnloadedFilter == null ? this.minUnloadedFilterEmpty: this.minUnloadedFilter,
    ...
    createRestockSession(): void {
        this.createOrEditRestockSessionModal.show();        
    }
